...
#[derive(Debug)]
pub struct YearnVaultProcessor {
    verbose: bool,
    processed_count: usize,
}

impl YearnVaultProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting YearnVault processing");
    
    let mut processor = YearnVaultProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = YearnVaultProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = YearnVaultProcessor::new(false);
